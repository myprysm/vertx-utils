...
import static fr.myprysm.vertx.json.JsonHelpers.*;
...
class JsonHelpersTest {
    ...
    void testExtractors() {
        ...
        assertThat(extractObject(obj, "nested.array")).hasValue(arr().add("item"));
        assertThat(extractString(obj, "nested.array")).hasValue(arr().add("item").toString());
