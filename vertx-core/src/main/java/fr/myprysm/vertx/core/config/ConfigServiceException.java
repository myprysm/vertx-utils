...
public class ConfigServiceException extends ServiceException {
    ...
    public ConfigServiceException(int failureCode, String message) {
        super(failureCode, message);
    }

    public ConfigServiceException(ServiceException exc) {
        this(exc.failureCode(), exc.getMessage());
    }

//    public ConfigServiceException(int failureCode, String message, JsonObject debugInfo) {
