...
/**
 * Converter for {@link SingleBucketAggregation}.
 * <p>
 * NOTE: This class has been automatically generated from the {@link SingleBucketAggregation} original class using Vert.x codegen.
 */
public class SingleBucketAggregationConverter {

    @SuppressWarnings("Duplicates")
    public static void fromJson(JsonObject json, SingleBucketAggregation obj) {
    ...
    public static void toJson(SingleBucketAggregation obj, JsonObject json) {
