...
public class Filters extends Aggregation {
    ...
    public Filters(JsonObject json) {
        super(json);
        FiltersConverter.fromJson(json, this);
    }

    /**
     * Transforms the <code>Filters</code> into a <code>JsonObject</code>,
    ...
    public JsonObject toJson() {
        ...
        FiltersConverter.toJson(this, json);
        return json;
    }
}
