...
|===
^|Name | Type ^| Description
|[[buckets]]`buckets`|`link:dataobjects.html#Bucket[Bucket]`|-
|[[data]]`data`|`Json object`|-
|[[metaData]]`metaData`|`Json object`|-
|[[name]]`name`|`String`|-
|[[type]]`type`|`String`|-
...
|[[metaData]]`metaData`|`Json object`|-
|[[name]]`name`|`String`|-
|[[results]]`results`|`link:dataobjects.html#MatrixStatsResult[MatrixStatsResult]`|-
|[[type]]`type`|`String`|-
|===
...
|===
^|Name | Type ^| Description
|[[correlation]]`correlation`|`Number (Double)`|-
|[[count]]`count`|`Number (Long)`|-
|[[covariance]]`covariance`|`Number (Double)`|-
|[[kurtosis]]`kurtosis`|`Number (Double)`|-
|[[mean]]`mean`|`Number (Double)`|-
|[[name]]`name`|`String`|-
|[[skewness]]`skewness`|`Number (Double)`|-
|[[variance]]`variance`|`Number (Double)`|-
|===
